...
def test_fine_tune(args, net, loaders):
    ...
    net_fine_tune = copy.deepcopy(net)
    net_fine_tune = net_fine_tune.cuda()
    optimizer = torch.optim.Adam(net_fine_tune.parameters(), lr=args.lr)
    ...
    for epoch in range(start_epoch, args.epochs + start_epoch):
        ...
        for j in range(times):
            ...
            Noise = {}
            # Add noise
            for name, param in net_fine_tune.named_parameters():
